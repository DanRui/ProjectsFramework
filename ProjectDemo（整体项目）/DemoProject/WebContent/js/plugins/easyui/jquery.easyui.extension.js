		...
		for(var i = 0;i<columns.length;i++){
			...
			if(columns[i].type == "text"){
				...
				if(columns[i].section){
					...
					s+='<input type="text" o_type = "date" id = "'+f_field+'" style = "width:100px" class = "search_input easyui-datebox">&nbsp;&nbsp&nbsp至&nbsp;&nbsp&nbsp';
					s+='<input type="text" o_type = "date" id = "'+e_field+'" style = "width:100px" class = "search_input easyui-datebox">'
				}else{
					s+='<input type="text" o_type = "date" id = "'+columns[i].field+'" style = "width:100px" class = "search_input easyui-datebox">';
				}
			}else if(columns[i].type == "datetime"){
				if(columns[i].section){
					var f_field = columns[i].startField;
					var e_field = columns[i].endField;
					s+='<input type="text" o_type = "date" id = "'+f_field+'" style = "width:150px" class = "search_input easyui-datetimebox">&nbsp;&nbsp&nbsp至&nbsp;&nbsp&nbsp';
					s+='<input type="text" o_type = "date" id = "'+e_field+'" style = "width:150px" class = "search_input easyui-datebox">'
				}else{
