...
<title>深圳警视通Web_Demo</title>
<link rel="shortcut icon" href="<%=basePath%>/images/dumptruck.png" type="image/x-icon">
...
<body class="easyui-layout">
	...
	<div title="功能菜单" data-options="region:'west',split:true" style="width:245px;">
		<div id="index-accordion" class="easyui-accordion" data-options="border:false,fit:true"></div>
	</div>
